...
# tiny: 384| large: ?| ResNet: 1024
_C.MODEL.HEADS.LOCAL_IN_FEAT = 1024
# Input feature dimension
# tiny: 768| large: 1536
...
# transformer options
# ------------------------------------------------------------------------------------ #
_C.SWINTRANS = CfgNode()

# Transformer pretrained paremeter
_C.SWINTRANS.PRETRAINED = False
...
# Save model checkpoint every(5) checkpoint period epochs
